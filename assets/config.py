from assets.model.unet import ScaleAt
from assets.model.latentnet import *
from assets.diffusion.resample import UniformSampler
from assets.diffusion.diffusion import space_timesteps
from typing import Tuple

from torch.utils.data import DataLoader

from assets.config_base import BaseConfig
from assets.dataset import *
from assets.diffusion import *
from assets.diffusion.base import GenerativeType, LossType, ModelMeanType, ModelVarType, get_named_beta_schedule
from assets.model import *
from assets.choices import *
from multiprocessing import get_context
import os
from assets.dataset_util import *
...
class TrainConfig(BaseConfig):
    ...
    latent_beta_scheduler: str = 'vp'
    beta_scheduler: str = 'vp'
    data_name: str = ''
